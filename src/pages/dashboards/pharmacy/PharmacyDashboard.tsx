                      ...
                      <CardContent className="p-4">
                        <div className="flex justify-between items-start">
                          ...
                          <div className="flex space-x-2">
                            ...
                            >
                              {fulfillingId === request._id ? 'Processing...' : 'Mark Ready'}
                            </Button>
                            <Button
                              size="sm"
                              variant="outline"
              ...
              <div className="space-y-4">
                {readyForPickupRequests.length === 0 ? (
                  <div className="text-center py-8">
                    ...
                    <p className="text-gray-500">No ready requests</p>
                  </div>
                ) : (
                      ...
                      <CardContent className="p-4">
                        <div className="flex justify-between items-start">
                          <div className="flex-1">
                            ...
                            <p className="text-sm text-gray-600 mb-2">{request.title}</p>
                            <p className="text-xs text-gray-500">
                              Ready: {new Date(request.updatedAt).toLocaleDateString()}
                            </p>
                          </div>
                          <Button
                            size="sm"
                            ...
                            disabled={fulfillingId === request._id}
                          >
                            {fulfillingId === request._id ? 'Processing...' : 'Mark Completed'}
                          </Button>
                        </div>
                      </CardContent>
                    </Card>
