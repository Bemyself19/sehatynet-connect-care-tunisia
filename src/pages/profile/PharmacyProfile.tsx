...
const PharmacyProfile: React.FC = () => {
  ...
  const { provider, loading, error } = useProvider(id, 'pharmacy');
  ...
  if (error || !provider) return <div className="text-center text-red-500">{error || 'Pharmacy not found'}</div>;
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600">Update your pharmacy information and preferences</p>
        </div>
          ...
          <form onSubmit={handleSave} className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Your basic pharmacy details</CardDescription>
              </CardHeader>
            ...
            <div className="flex space-x-4">
              ...
              <Link to="/dashboard/pharmacy"><Button type="button" variant="outline">Cancel</Button></Link>
            </div>
          </form>
        ) : error || !provider ? (
          <div className="text-center text-red-500">{error || 'Pharmacy not found'}</div>
        ) : (
